...
function AuthLoading(props) {
      ...
      if(def1 && def1.langLocale){
        ...
        if (result && result !== 'undefined' && result !== 'null' && result !== '') {
          try {
            ...
            if (parsedResult && typeof parsedResult === 'object' && parsedResult.langLocale && parsedResult.dateLocale) {
              let langLocale = parsedResult.langLocale;
              let dateLocale = parsedResult.dateLocale;
              if (obj[langLocale] && typeof obj[langLocale] === 'object') {
                ...
                // Fallback to default language if translation object is invalid
                if (obj[def1.langLocale] && typeof obj[def1.langLocale] === 'object') {
                  i18n.addResourceBundle(
                    def1.langLocale,
                    "translations",
                    obj[def1.langLocale]
              ...
              // Fallback to default language if parsed result is invalid
              if (obj[def1.langLocale] && typeof obj[def1.langLocale] === 'object') {
                i18n.addResourceBundle(
                  def1.langLocale,
                  "translations",
            ...
            console.log("Error parsing localStorage lang:", error);
            // Clear corrupted localStorage and use default
  ...
  return settingsdata.loading ? (
    ...
    (auth && auth.loading) || !languagedata.langlist ? (
      <CircularLoading />
    ) : (
      props.children
    )
